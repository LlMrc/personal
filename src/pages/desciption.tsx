...
export default function Desciption() {
  ...
  return (
    <section data-scroll-section className={`${styles.paddings} bg-[#eaf4f7] pt-24`}>
          ...
          className={`relative w-full flex  mx-auto justify-center   md:py-10 px-6 md:px-0   ${styles.interWidth} ${styles.yPaddings} `}>
             <div className='absolute mix-blend-multiply animate-blob  animation-delay-400 filter blur-xl opacity-60 h-64 w-60  left-32 bg-purple-300 rounded-full'/>      
             <div className='absolute mix-blend-multiply animate-blob filter blur-xl opacity-60 h-64 w-60  -left-20 bg-yellow-400 rounded-full'/>       
             <div className='absolute mix-blend-multiply filter animate-blob animation-delay-200 blur-xl opacity-60 h-64 w-60 -bottom-0 -left-0  bg-pink-400 rounded-full'/>        
