        ...
        <div className="container">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12 ">
              <div className="relative p-8 bg-white shadow-lg rounded-lg sm:p-12 border-2">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
...
const ContactTextArea = ( props: TextAreaProps  ) => {
  return (
    <>
      <div className="mb-6">
        <textarea
...
const ContactInputBox = (props: InputProps ) : JSX.Element => {
  return (
    <>
      <div className="mb-6">
        <input
