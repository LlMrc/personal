  ...
  return (
      ...
      <div
        ...
        className={
          ...
          " z-100 sticky h-14 md:bg-hero bg-black bg-cover md:bg-slate-400 md:border-2 border-gray-200 opacity-70 md:text-black text-skin-muted justify-around flex items-center "/*md:m-1 lg:w-2/6 md:w-2/5*/
        }
      >
        <div className="hidden md:block">
        <img className="h-16 w-24 bg-slate-900"
          src={masha} alt="masha logo" />
        </div>
