    ...
    <section data-scroll-section>
        ...
        <div className="-m-1 flex flex-wrap md:-m-2">
          ...
          <div className="flex w-1/2 flex-wrap">
            ...
            <div className="   relative group text-skin-fill w-full p-1 md:p-2">
              <img
                alt="gallery"
                className="block h-full w-full group-hover:rotate-2 rounded-lg object-cover object-center"
                src={
      ...
      <div className="w-full flex md:w-3/6 mx-auto justify-start   md:py-10 px-6 md:px-0  md:mt-14 ">
        <div className="bg-shad-color p-4   rounded  md:shadow-lg shadow-primary md:w-3/4">
          <h2 className="uppercase  border-b-4  border-accent p-2 mb-4  text-skin-secondary font-semibold">
