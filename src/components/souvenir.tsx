...
const Souvenir = () => {
  ...
  return (
    <section className=" my-20   w-full rounded" data-scroll-section>
      ...
      <div className="md:text-end  md:mr-4 w-full justify-center flex overflow-x-scroll container-snap md:text-lg ">
      ...
      <div className="relative md:mx-auto md:h-[400px] md:w-[700px] md:p-2 md:my-8 shadow-md shadow-secondary overflow-hidden after:clear-both after:block after:content-[''] group">
        <div
          key={slide[0].id}
